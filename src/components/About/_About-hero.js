...
import aboutHeroImg from "../../image/About-hero.png";
        ...
        <div id="about-hero">
            <div className="container">
                <div className="about-hero">
                    <div className="about-hero_bg">
                        <img src={aboutHeroImg} alt=""/>
                    </div>
                    <div className="about-hero_desc">
                        <span className="about-hero_desc-subtitle">About Us</span>
                        <h1 className="about-hero_desc-title">Best Education Platform</h1>
